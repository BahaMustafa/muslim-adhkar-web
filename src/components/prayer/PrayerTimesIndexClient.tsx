...
import { formatTime } from '@/lib/prayer-utils';

type LocalPrayerData = {
    city: string;
    prayers: {
        fajr: Date;
        sunrise: Date;
...
export default function PrayerTimesIndexClient() {
    const { t, language } = useLanguage();
    const isAr = language === 'ar';
    const [localData, setLocalData] = useState<LocalPrayerData | null>(null);

    const handleDataLoaded = (data: LocalPrayerData) => {
        setLocalData(data);
    };
